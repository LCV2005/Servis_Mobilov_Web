    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        <div class="service-item" style="margin-bottom: 24px;">
          <h4>Ako nakupovat na podstranke prislusenstvo</h4>
          <p>Poslite nam model zariadenia a typ doplnku. My potvrdime cenu aj dostupnost.</p>
          <p><strong>Dorucenie:</strong> osobny odber alebo kurier. Pri vacsej objednavke ponukame mnozstevnu zlavu.</p>
          <div class="gradient-button" style="margin-top: 12px;"><a href="<?php echo $basePath; ?>podstranky/objednat-servis.php">Prejst na objednavku doplnkov</a></div>
        </div>
      </div>
    </div>
  </div>
